...
const Article1 = () => {
    return (
        <div>
            <article className='pt-[120px] pb-[165px] justify-evenly overflow-hidden justify-center flex flex-wrap w-[90%] justify-self-center max-md:w-full p-[16px]'>
                <div className="leftSide pt-[50px] w-[37%] max-xl:w-[90%] max-xl:justify-self-cente">
                    ...
                    <div className='ardich py-[12px] max-md:py-[5px] text-[42px] max-md:text-3xl articleHead max-md:leading-[35px] leading-[50px] font-medium'>We propose and discuss design rules</div>
                    <p className='py-[32px] max-md:py-[20px] max-md:text-[14px] text-gray-700'>Metasurfaces are generally designed by placing scatterers in periodic or pseudo-periodic grids. We propose and discuss design rules for functional metasurfaces with randomly placed.
                    </p>
                    ...
                    <button className='text-black heroBtn py-[12px] my-[24px] px-[18px] max-md:scale-[0.80] font-bold text-[20px] rounded'>
                ...
                <div className="rightSide h-[600px] max-xl:my-9 max-sm:ml-6 w-[470px]">
